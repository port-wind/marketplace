...
3. Run `"${CLI_PATH:-curl-crypto}" self-test` immediately after discovery or installation.
...
5. If the command returns `RUNTIME_BUNDLE_REQUIRED`, tell the user to ask Leo for `runtime.dat`.
